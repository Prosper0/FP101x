...
-- Ex. 2
-- ===================================
-- 5,8,3,2,1 => 5,16,3,4,1

doubleSecond :: [Integer] -> [Integer]  
doubleSecond = zipWith ($) (cycle [id,(*2)])
-- begin w rightmost? zipWith ($) (cycle [(*2),id])
{- doesn't work on un-even length lists
doubleSecond [] = []
doubleSecond (x:[]) = [x]
doubleSecond (x:y:zs)
    | (length (x:y:zs)) `mod` 2 /= 0 = x*2 : y : doubleSecond zs
    | otherwise = x : y*2 : doubleSecond zs
-}

-- ===================================
-- Ex. 3
-- ===================================
-- 5,16,3,4,1 => 5+1+6+3+4+1 = 20
